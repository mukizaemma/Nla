@section('title', 'School Staff')

<div>
    <div class="bg-light rounded p-4">
        <div class="d-flex flex-wrap align-items-center justify-content-between mb-3">
            <h4 class="mb-2">School Staff</h4>
            ...
            <table class="table table-striped table-hover align-middle w-100">
                <thead>
                    <tr>
                        ...
                        <th>Full Name</th>
                        <th style="width: 180px;">Role / Position</th>
            ...
            <div class="modal-dialog modal-lg modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">{{ $editingId ? 'Edit Staff Member' : 'New Staff Member' }}</h5>
                    ...
                    <div class="modal-body">
                        <form wire:submit.prevent="save" id="leadership-form">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control summernote" wire:model.defer="biography" rows="4" data-summernote-height="220"></textarea>
